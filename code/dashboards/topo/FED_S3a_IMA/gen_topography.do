...
local general_source = "FED_S3a_IMA" 
qui local sector_list S1M 
qui local country_list US 

global grid "${topo_dir_raw}/FED_S3a_IMA/intermediate"
global bycountry_data "${topo_dir_raw}/FED_S3a_IMA/intermediate/populated_grid"
global cmappings "${topo_dir_raw}/FED_S3a_IMA/auxiliary files"
global intermediate "${topo_dir_raw}/FED_S3a_IMA/intermediate to erase"
...
global output "${topo_dir_raw}/FED_S3a_IMA/final table"
save "${output}/FED_S3a_IMA_warehouse.dta", replace
export delimited using "${output}/FED_S3a_IMA_warehouse.csv", replace
